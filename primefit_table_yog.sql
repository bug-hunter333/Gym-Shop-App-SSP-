...
--
-- Dumping data for table `yog`
--

INSERT INTO `yog` (`id`, `name`, `description`, `price`, `quantity`, `image_url`, `created_at`, `updated_at`) VALUES
